...
//        });
        ...
        mFirebaseAnalytics.setCurrentScreen(this, "ActivityMain",null);
        ...
        Ai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ActivityMain.this, ActivityName.class);
        ...
        ds.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityMain.this, ActivityTwoPlayers.class);
                startActivity(intent);
            }
        });
    ...
    public void presentActivity(View view) {
        ...
        intent.putExtra(ActivitySettings.
