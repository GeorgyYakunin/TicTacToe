...
public class ActivityTwoPlayers extends AppCompatActivity {
...
//    private AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two_players_act);
...
*/
        ...
        ds.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ActivityTwoPlayers.this, ActivityChoose.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ActivityTwoPlayers.this, ActivityMain.class);
